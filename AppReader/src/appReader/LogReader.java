...
public class LogReader extends JFrame implements ActionListener{
	...
	//REGISTRAZIONE
	JLabel lblName, lblSurname, lblUserID, lblPhone, lblEmail, lblPswReg, lblConfPswReg , lblInq, lblInqSe;
	JPasswordField txtPswReg,txtConfPswReg;
	JTextField txtName, txtSurname, txtUserID, txtPhone, txtEmail;
	JComboBox jcInq, jcSez;
	//ComboBox lblInq, lblInqSe;
	...
	//private String inquadramento ="Studente";
	public LogReader(){
		setSize(300, 440);
		setLocation(450, 160);
		setTitle("AppReader");
        ...
        lblTitle = new JLabel("APP READER", SwingConstants.CENTER);
        ...
        lblTitleR = new JLabel("APP READER", SwingConstants.CENTER);
        ...
        panelRegistration.add(panelFormReg4);
		...
		if(e.getSource()==logIn){
			...
			try {
				...
				if(temp.equals("OK")){
					...
					temp = in.readLine();
					if(temp.equals("1")){
						new AppReader(socket,txtUsernameLog.getText());
						this.dispose();
